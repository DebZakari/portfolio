...
const githubLink = (
  ...
  <a
    href="https://github.com/DebZakari/portfolio"
    target="_blank"
    rel="noopener noreferrer"
    aria-label={
      stars !== null
        ? `View portfolio source on GitHub — ${stars} stars`
  ...
  >
    <GitHubMark size={12} />
    <span>DebZakari/portfolio</span>
    {stars !== null && (
      <>
        <span style={{ opacity: 0.3 }} aria-hidden="true">·</span>
        <Star size={10} strokeWidth={1.5} aria-hidden="true" />
        <span>{stars}</span>
      </>
    )}
  </a>
...
export default function Footer() {
  ...
  return (
    <footer style={{ borderTop: "1px solid var(--border)" }}>
      {/* Mobile: GitHub link only, centered */}
      <div
      ...
      >
        {githubLink(stars, hoverHandlers)}
      </div>

      {/* Desktop: copyright left, GitHub + stack right */}
      <div
      ...
      >
        <span
          className="font-mono"
          style={{ fontSize: 11, color: "var(--text-dim)", letterSpacing: "0.10em" }}
        >
